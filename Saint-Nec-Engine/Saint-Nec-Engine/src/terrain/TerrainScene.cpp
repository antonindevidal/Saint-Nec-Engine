...
void TerrainScene::load()
{
	...
	addGameObject(cube);
	cube->addComponent(new TerrainComponent("resources/textures/heightmap_puy_de_dome.jpg","resources/shaders/terrain/basic_terrain.vert", "resources/shaders/terrain/basic_terrain.frag", 10, 10, 1));
